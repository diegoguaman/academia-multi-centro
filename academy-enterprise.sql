...
CREATE TABLE datos_personales (
    ...
    updated_by INT REFERENCES usuario(id_usuario)
);
...
CREATE TABLE centro (
    ...
    id_comunidad INT REFERENCES comunidad(id_comunidad),
...
CREATE TABLE convocatoria (
    ...
    id_centro INT REFERENCES centro(id_centro),
...
CREATE TABLE matricula (
    ...
    -- SUBVENCIONES
    id_entidad_subvencionadora INT REFERENCES entidad_subvencionadora(id_entidad),
